    ...
    <section id="about" className="px-4 py-14 sm:px-8 sm:py-20">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="rounded-[28px] border border-black/10 bg-transparent px-6 py-12 sm:px-14 sm:py-16">
          <p className="text-center text-[clamp(18px,2.4vw,28px)] leading-[1.45] tracking-tight text-muted-ink">
            ...
            <span className="font-serif italic text-muted-ink">products, people,</span> and the
